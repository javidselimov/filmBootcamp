            ...
            <ul className="favorites__list">
                {state.movies.map((movie) => (
                    <li key={movie.imdbID}>
                        ...
                        <button className='remove' onClick={() => handleRemoveMovie(movie.imdbID)}>X</button>
                    </li>
                ))}
            </ul>
            ...
            {state.isSaved && (
                <div>
                    <a href={`/list/${state.savedId}`} target="_blank" rel="noopener noreferrer">
                        <button>Keçidə klikləyin</button>
                    </a>
                    <button className='newList' onClick={handleCreateNewList}>Yeni Siyahı Yarat</button>
                </div>
            )}
        </div>
    );
